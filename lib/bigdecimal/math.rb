...
module BigMath
  ...
  #
  def cbrt(x, prec)
    BigDecimal::Internal.validate_prec(prec, :cbrt)
  ...
  #
  def hypot(x, y, prec)
    BigDecimal::Internal.validate_prec(prec, :hypot)
  ...
  #
  def asin(x, prec)
    BigDecimal::Internal.validate_prec(prec, :asin)
  ...
  #
  def acos(x, prec)
    BigDecimal::Internal.validate_prec(prec, :acos)
  ...
  #
  def atan2(y, x, prec)
    BigDecimal::Internal.validate_prec(prec, :atan2)
  ...
  #
  def sinh(x, prec)
    BigDecimal::Internal.validate_prec(prec, :sinh)
  ...
  #
  def cosh(x, prec)
    BigDecimal::Internal.validate_prec(prec, :cosh)
  ...
  #
  def tanh(x, prec)
    BigDecimal::Internal.validate_prec(prec, :tanh)
  ...
  #
  def asinh(x, prec)
    BigDecimal::Internal.validate_prec(prec, :asinh)
  ...
  #
  def acosh(x, prec)
    BigDecimal::Internal.validate_prec(prec, :acosh)
  ...
  #
  def atanh(x, prec)
    BigDecimal::Internal.validate_prec(prec, :atanh)
  ...
  #
  def log2(x, prec)
    BigDecimal::Internal.validate_prec(prec, :log2)
  ...
  #
  def log10(x, prec)
    BigDecimal::Internal.validate_prec(prec, :log10)
